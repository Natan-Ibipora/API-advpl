...
User Function getToken()
    ...
    cUserName  := "natan-santos" // type here user name
    cPassword  := "1234" // type here user password
    cBaseURL   := "http://192.168.246.12:8097/rest" // type here your base URL
    cPath      := "/api/oauth2/v1/token?grant_type=passowrd&username=natan-santos&password=1234"
    aHeader    := {}

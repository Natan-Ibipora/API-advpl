...
WSRESTFUL cliente Description "API para retorno de clientes"       

    WSMETHOD GET DESCRIPTION "Retorna os dados essenciais dos clientes" WSSYNTAX "cliente/" PATH "/cliente"      
    
END WSRESTFUL

L
//Pega todos os registros da tabela CTT;
WSMETHOD GET  WSSERVICE zWCliente
    Local lPost := .T.   
    Local cQuery 
    Local aTasks:={}    
